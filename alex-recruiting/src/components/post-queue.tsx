...
const sampleDrafts: PostDraft[] = [
  {
    ...
    pillar: "work_ethic",
    hashtags: ["#2029Recruit", "#FootballRecruiting", "#OL", "#PutInTheWork", "#WisconsinFootball"],
  ...
  {
    id: "draft-3",
    content: "Honor roll this semester. Balancing the books and the field — D1 programs want student-athletes.\n\n#2029Recruit #FootballRecruiting #WisconsinFootball",
    pillar: "character",
    hashtags: ["#2029Recruit", "#FootballRecruiting", "#WisconsinFootball"],
