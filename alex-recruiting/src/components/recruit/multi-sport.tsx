...
export function MultiSportSection() {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(245,158,11,0.12),transparent_28%),radial-gradient(circle_at_80%_20%,rgba(239,68,68,0.12),transparent_24%),linear-gradient(180deg,rgba(10,10,10,0.98),rgba(8,8,8,0.94))]" />
