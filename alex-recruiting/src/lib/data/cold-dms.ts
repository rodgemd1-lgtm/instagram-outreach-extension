...
export const coldDMLibrary: ColdDM[] = [
  // ─── INITIAL OUTREACH (8+) ──────────────────────────────────────
  {
    ...
    template: `Coach {COACH_LAST_NAME}, my name is Jacob Rodgers. I'm a Class of 2029 OL from Pewaukee High School in Wisconsin (6'4", 285 lbs). I have tremendous respect for {SCHOOL_NAME} and the way your program develops offensive linemen. I'd be honored to be on your radar. Here's my NCSA profile with updated film: {NCSA_LINK}. Thank you for your time, Coach.`,
    sequence: "initial",
    tier: "Tier 1",
  ...
  },
  {
    ...
    template: `Coach {COACH_LAST_NAME}, I'm Jacob Rodgers, a 2029 OL (6'4", 285) from Pewaukee HS in Wisconsin. I've been following {SCHOOL_NAME} closely and I'm impressed by {SPECIFIC_DETAIL}. Training at @IMGAcademy and working to be the best OL in my class. I'd love to be considered as a recruit. Full film: {NCSA_LINK}. Thank you, Coach.`,
    sequence: "initial",
    tier: "Tier 1",
  ...
  },
  {
    ...
    template: `Coach {COACH_LAST_NAME}, I'm Jacob Rodgers — 2029 OL, 6'4" 285, from Pewaukee HS in Wisconsin. I train at @IMGAcademy and I'm represented by NCSA. {SCHOOL_NAME} is a program I'm very interested in, and I think my physical profile and work ethic fit what you're building. Here's my updated film: {NCSA_LINK}. Would love to connect, Coach.`,
    sequence: "initial",
    tier: "Tier 2",
  ...
  },
  {
    ...
    template: `Coach {COACH_LAST_NAME}, my name is Jacob Rodgers — 2029 OL, 6'4" 285, Pewaukee HS, Wisconsin. I've done my research on {SCHOOL_NAME} and I believe it could be a great fit for me both academically and athletically. I'd love to schedule a campus visit and meet with the coaching staff. My film: {NCSA_LINK}. Looking forward to connecting, Coach.`,
    sequence: "initial",
    tier: "Tier 3",
  ...
  },
  {
    ...
    template: `Coach {COACH_LAST_NAME}, I'm Jacob Rodgers, a Class of 2029 OL from Pewaukee HS, Wisconsin (6'4", 285). My NCSA recruiting advisor suggested I reach out to {SCHOOL_NAME} based on my profile and your program's recruiting needs. I'd love to be on your board. Here's my full profile: {NCSA_LINK}. Thank you for your time, Coach.`,
    sequence: "initial",
    tier: "all",
  ...
  },
  {
    ...
    template: `Coach {COACH_LAST_NAME}, following up from my earlier message. I recently {ACHIEVEMENT} and wanted to share the update. I'm Jacob Rodgers, 2029 OL (6'4", 285) from Pewaukee, WI. Still very interested in {SCHOOL_NAME} and what you're building. Updated profile: {NCSA_LINK}. Thank you for your time, Coach.`,
    sequence: "follow_up_1",
    tier: "all",
  ...
  },
  {
    ...
    template: `Coach {COACH_LAST_NAME}, just a quick check-in. Jacob Rodgers here — 2029 OL, 6'4" 285, Pewaukee HS, WI. Continuing to train hard at @IMGAcademy and my film is getting better each week. I respect how busy recruiting season is, but I wanted to stay on your radar for {SCHOOL_NAME}. Latest film: {NCSA_LINK}. Thank you, Coach.`,
  ...
  },
  {
    ...
    template: `Coach {COACH_LAST_NAME}, Jacob Rodgers here with an update. Since my last message, I've {GROWTH_UPDATE}. I'm now {UPDATED_STATS}. My film continues to improve and I'm training year-round at @IMGAcademy. If there's ever a chance to connect about {SCHOOL_NAME}, I'm ready. Latest film: {NCSA_LINK}. Appreciate your time, Coach.`,
    sequence: "follow_up_3",
    tier: "all",
  ...
  },
  {
    ...
    template: `Coach {COACH_LAST_NAME}, I noticed you liked my recent post — thank you! That means a lot coming from a coach at {SCHOOL_NAME}. I'm Jacob Rodgers, 2029 OL (6'4", 285) from Pewaukee, WI. I'd love to learn more about your program and share my updated film: {NCSA_LINK}. Appreciate the support, Coach.`,
    sequence: "trigger",
    tier: "all",
  ...
  },
  {
    ...
    template: `Coach {COACH_LAST_NAME}, wanted to share an update — {MILESTONE_DETAIL}. The hard work is paying off and I'm continuing to develop every week. I'm Jacob Rodgers, 2029 OL (6'4", 285) from Pewaukee HS, WI. {SCHOOL_NAME} is a program I'm very interested in. Latest film: {NCSA_LINK}. Thank you, Coach.`,
    sequence: "trigger",
    tier: "all",
  ...
  },
  {
    id: "rel-004",
    name: "Camp Invite",
    template: `Coach {COACH_LAST_NAME}, I see {SCHOOL_NAME} has a camp coming up on {CAMP_DATE}. I'd love to attend and compete in front of your coaching staff. Is there still availability? I'm Jacob Rodgers, 2029 OL (6'4", 285) from Pewaukee, WI. Looking forward to the opportunity. Thank you, Coach.`,
    sequence: "relationship",
    tier: "all",
