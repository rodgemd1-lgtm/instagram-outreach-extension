// Jacob Rogers — Complete X (Twitter) Profile Blueprint & First 30 Posts
...
export const jacobXProfile = {
  ...
  handle: "@JacobRogersOL28",
  bio: 'OL | 6\'4" 285 | Pewaukee HS \'28 | WI | Training @IMGAcademy | NCSA Athlete | Film \u2B07\uFE0F',
  location: "Pewaukee, Wisconsin",
  website: "",
  headerImageDescription:
    'Action shot from game \u2014 Jacob in stance at the line. Dark overlay with stats: 6\'4" | 285 | Class of 2028 | Pewaukee, WI',
  ...
  checklist: [
    ...
    },
    {
      id: "header",
      label: "Header image",
      description: 'Action shot with stats overlay: 6\'4" | 285 | Class of 2028 | Pewaukee, WI',
      complete: false,
    },
    {
      id: "display_name",
      label: "Display name",
      description: "Jacob Rogers | OL | '28",
      complete: true,
    },
    {
      id: "bio",
  ...
  thirtyDayGoals: [
    ...
    "Upload 4+ film clips",
    "Connect with 25+ recruits in Class of 2028",
  ],
  ...
  posts: [
    ...
    },
    {
      ...
      pillar: "performance",
      content:
        "Working on first-step quickness and hand placement. Drive block from last Friday's game — finishing through the whistle every time.\n\nFull film: [NCSA Link]\n\n#OL #OffensiveLine #2028Recruit #FootballRecruiting #BigTenFootball",
      hashtags: ["#OL", "#OffensiveLine", "#2028Recruit", "#FootballRecruiting", "#BigTenFootball"],
      mediaType: "video",
    ...
    },
    {
      ...
      hashtags: ["#2028Recruit", "#OL", "#FootballRecruiting", "#WisconsinFootball"],
      mediaType: "text",
    ...
    },
    {
      ...
      pillar: "performance",
      content:
        'Pass pro rep from Week 3. Keeping the pocket clean. 6\'4" 285 and moving my feet.\n\nCoaches — DMs are open.\n\n\uD83C\uDFA5 [HUDL Link]\n\n#OL #2028Recruit #OffensiveLine #FootballRecruiting #RecruitMe',
      hashtags: ["#OL", "#2028Recruit", "#OffensiveLine", "#FootballRecruiting", "#RecruitMe"],
      mediaType: "video",
    ...
    },
    {
      ...
      pillar: "performance",
      content:
        "Game day.\n\nTime to go to work.\n\n#FridayNightLights #2028Recruit #OL #WisconsinFootball #GameDay",
      hashtags: ["#FridayNightLights", "#2028Recruit", "#OL", "#WisconsinFootball", "#GameDay"],
      mediaType: "photo",
    ...
    // ── WEEK 2: Establishing Consistency ──────────────────────────────────
    {
      ...
      pillar: "work_ethic",
      content:
        "5:30 AM. Nobody else in the weight room.\n\nSquats, cleans, sled work. Building the foundation.\n\nThe grind doesn't take days off.\n\n#2028Recruit #OL #PutInTheWork #OffensiveLine #FootballRecruiting",
      hashtags: ["#2028Recruit", "#OL", "#PutInTheWork", "#OffensiveLine", "#FootballRecruiting"],
      mediaType: "video",
    ...
    },
    {
      ...
      pillar: "performance",
      content:
        "Breakdown from Friday's win:\n\n\u2022 100% snap count\n\u2022 0 sacks allowed\n\u2022 Team rushed for 210+ yards\n\nDoing my job. Getting better.\n\n\uD83C\uDFA5 Full highlights: [HUDL Link]\n\n#OL #2028Recruit #FootballRecruiting #WisconsinFootball",
      hashtags: ["#OL", "#2028Recruit", "#FootballRecruiting", "#WisconsinFootball"],
      mediaType: "video",
    ...
    },
    {
      ...
      pillar: "performance",
      content:
        "Rivalry week. Biggest game of the year.\n\nWe've been preparing for this one all season. Time to execute.\n\nLet's ride. \uD83D\uDD25\n\n#FridayNightLights #2028Recruit #OL #WisconsinFootball",
      hashtags: ["#FridayNightLights", "#2028Recruit", "#OL", "#WisconsinFootball"],
      mediaType: "photo",
    ...
    },
    {
      ...
      pillar: "performance",
      content:
        "Pancake block compilation from Weeks 1-4.\n\nFinishing. Every. Single. Rep.\n\n\uD83C\uDFA5 Full season film: [HUDL Link]\n\n#OL #OffensiveLine #2028Recruit #FootballRecruiting #RecruitMe",
      hashtags: ["#OL", "#OffensiveLine", "#2028Recruit", "#FootballRecruiting", "#RecruitMe"],
      mediaType: "video",
    ...
    },
    {
      ...
      pillar: "performance",
      content:
        "Down block + second-level combo from last week. Communication and timing with my guard.\n\nThis is what winning in the trenches looks like.\n\n\uD83C\uDFA5 [HUDL Link]\n\n#OL #2028Recruit #OffensiveLine #FootballRecruiting #BigTenFootball",
      hashtags: ["#OL", "#2028Recruit", "#OffensiveLine", "#FootballRecruiting", "#BigTenFootball"],
      mediaType: "video",
    ...
    },
    {
      ...
      pillar: "performance",
      content:
        "Playoffs start tonight. Everything we've worked for comes down to this.\n\nPewaukee. Let's go.\n\n#FridayNightLights #2028Recruit #OL #Playoffs #WisconsinFootball",
      hashtags: ["#FridayNightLights", "#2028Recruit", "#OL", "#Playoffs", "#WisconsinFootball"],
      mediaType: "photo",
